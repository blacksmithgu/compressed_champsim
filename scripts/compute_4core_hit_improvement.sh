...
#    echo "$sc_file0 $sc_file1 $sc_file2 $sc_file3"
    ...
    core0_dut_hit_rate=`perl ${dir}/get_percore_hit_rate.pl $dut_file 0`
    core1_dut_hit_rate=`perl ${dir}/get_percore_hit_rate.pl $dut_file 1`
    core2_dut_hit_rate=`perl ${dir}/get_percore_hit_rate.pl $dut_file 2`
    core3_dut_hit_rate=`perl ${dir}/get_percore_hit_rate.pl $dut_file 3`
