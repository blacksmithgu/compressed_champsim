...
#    echo $f $benchmark 
    ...
    output_dir="/scratch/cluster/akanksha/CRCRealOutput/8core/PAC/$output/"
    ...
    #cd $output_dir
    command="/u/akanksha/ChampSim_public/ChampSim_public/scripts/run_8core.sh $binary 0 250 $num $output_dir"
#    echo $command
