...
$dut_mpki = $dut_mpki + compute_mpki($dut_stats_file, 4);
$dut_mpki = $dut_mpki + compute_mpki($dut_stats_file, 5);
$dut_mpki = $dut_mpki + compute_mpki($dut_stats_file, 6);
$dut_mpki = $dut_mpki + compute_mpki($dut_stats_file, 7);
