...
$dut_mpki = $dut_mpki + compute_mpki($baseline_stats_file, $dut_stats_file, 1);
$dut_mpki = $dut_mpki + compute_mpki($baseline_stats_file, $dut_stats_file, 2);
$dut_mpki = $dut_mpki + compute_mpki($baseline_stats_file, $dut_stats_file, 3);
